...
document.getElementById('color-trigger').addEventListener('click', ()=> {
    TweenMax.to('.slider-container', .3, { backgroundColor: 'black'});
    TweenMax.to('#h1-red', .3, { color: 'white'});
    ...
    document.getElementById('back').style.backgroundImage = 'url(/button/back-white.png)';
})
...
document.getElementById('color-trigger-2').addEventListener('click', ()=> {
    ...
    document.getElementById('back').style.backgroundImage = 'url(/button/back.png)';
})
...
document.getElementById('slider-items-1').addEventListener('click', function () {
    ...
    document.getElementById('pop-up-slider-items-img').src = `img/black/${img}.jpg`;
